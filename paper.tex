...
discrete random walk takes to visit vertex at least once.
...
That is, we can stay in the same vertex (if the collector receives the same coupon
two days in a row).
...
Then
\begin{align}
\tcov&=  r \left(\frac{1}{r}+\frac{1}{r-1}+\cdots+1\right). \nonumber
\end{align}
