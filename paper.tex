...
\abstract{
The cover time of a graph is the time it takes for a random walk to
visit all of its vertices.
We provide a detailed overview for a variety of cover time topics:
We begin by investigating the cover time of small and structured graphs but
quickly need a more robust strategy for larger, unstructured ones.
We apply more general probablistic arguments and an important electrical
network relationship to identify bounds.
