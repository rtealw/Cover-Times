...
A lower bound is certainly 365 but there is no upper bound.
...
\begin{align}
\tcov&= \E[X_1+X_2+X_3+\cdots+X_{n-1}] = \sum_{i=1}^{n-1} \E[X_i] \nonumber
\end{align}
...
It follows that $\E[X_i] = (n-1)/(n-i)$.
Then
\begin{align}
\tcov&=   \sum_{i=1}^{n-1} \frac{n-1}{n-i} \nonumber \\
