...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[scale = 2]
	    ...
	    \draw[span] (2) -- (3);
	\end{tikzpicture}
	\caption{A spanning tree of the complete graph with $n=4$.}\label{fig:span}
\end{figure}
...
We prove the following theorem and then use it to show that $\cov \sim \textrm{Pois}(e^{-x})$.
