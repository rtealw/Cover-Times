...
We begin by writing the expected cover time in a clever way
...
we visit $\sigma_k$ last is $\frac{1}{k}$.
Formally, $P(L_k = \sigma_k) = \frac{1}{k}$.
...
\cite{AF14} Proposition 2.3 -> Corollary 2.8 -> Corollary 3.11

\url{https://ocw.mit.edu/courses/mathematics/18-445-introduction-to-stochastic-processes-spring-2015/lecture-notes/MIT18_445S15_lecture8.pdf}
